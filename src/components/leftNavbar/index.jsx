...
export default function LeftNavbar() {
    return <div className="left-navbar">
        ...
        <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
            <SubMenu key="sub0" icon={<DashboardOutlined/>} title="Dashboard">
                <Menu.Item key="1">Analysis</Menu.Item>
                <Menu.Item key="2">Monitor</Menu.Item>
            </SubMenu>
            <SubMenu key="sub1" icon={<FormOutlined/>} title="Form">
            ...
            <SubMenu key="sub2" icon={<TableOutlined/>} title="Product">
                <Menu.Item key="7">Product 1</Menu.Item>
                <Menu.Item key="8">Product 2</Menu.Item>
            </SubMenu>
